...
- [code](Code/1- Individual- Phenology calculator.R)`1- Individual- Phenology calculator.R`: Calculates the departure and arrival dates into Greenland and Iceland for each tracked bird                                 
